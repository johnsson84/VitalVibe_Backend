...
public class AuthController {
    ...
    public ResponseEntity<?> signupUser(@Valid @RequestBody SignupRequest signupRequest) {
        ...
        User user = new User(signupRequest.getUsername(),
                ...
                encoder.encode(signupRequest.getPassword()), signupRequest.getFirstName(), signupRequest.getLastName(),signupRequest.getAge(),signupRequest.getWeight(), signupRequest.getVo2max());
